...
class DynamicAppColors {
  ...
  Color get surfaceSecondary =>
      isDark ? AppColorsDark.surfaceSecondary : AppColors.surfaceSecondary;
  Color get dividerSeparator =>
      isDark ? AppColorsDark.dividerSeparator : AppColors.dividerSeparator;

  // Accent colors
  Color get primaryAccent =>
      isDark ? AppColorsDark.primaryAccent : AppColors.primaryAccent;
  Color get luxuryGold =>
      isDark ? AppColorsDark.luxuryGold : AppColors.luxuryGold;
  Color get accentLight =>
      isDark ? AppColorsDark.accentLight : AppColors.accentLight;
  ...
  Color get textPlaceholder =>
      isDark ? AppColorsDark.textPlaceholder : AppColors.textPlaceholder;
  Color get textOnAccent =>
      isDark ? AppColorsDark.textOnAccent : AppColors.textOnAccent;
  Color get textOnGold =>
      isDark ? AppColorsDark.textOnGold : AppColors.textOnGold;
  ...
  Color get shadowColor =>
      isDark ? AppColorsDark.shadowColor : AppColors.shadowColor;
  Color get shadowColorMedium =>
      isDark ? AppColorsDark.shadowColorMedium : AppColors.shadowColorMedium;
  Color get shadowColorStrong =>
      isDark ? AppColorsDark.shadowColorStrong : AppColors.shadowColorStrong;
  Color get glassBackground =>
      isDark ? AppColorsDark.glassBackground : AppColors.glassBackground;
  Color get overlayBackground =>
      isDark ? AppColorsDark.overlayBackground : AppColors.overlayBackground;
  Color get overlayWhite =>
      isDark ? AppColorsDark.overlayWhite : AppColors.overlayWhite;

  // Borders
  Color get borderLight =>
      isDark ? AppColorsDark.borderLight : AppColors.borderLight;
  Color get borderMedium =>
      isDark ? AppColorsDark.borderMedium : AppColors.borderMedium;
  Color get borderAccent =>
      isDark ? AppColorsDark.borderAccent : AppColors.borderAccent;

  // Chat specific
  Color get chatBackground =>
      isDark ? AppColorsDark.chatBackground : AppColors.chatBackground;
  Color get chatBubbleUser =>
      isDark ? AppColorsDark.chatBubbleUser : AppColors.chatBubbleUser;
  Color get chatBubbleOther =>
      isDark ? AppColorsDark.chatBubbleOther : AppColors.chatBubbleOther;
  Color get chatInputBackground => isDark
      ? AppColorsDark.chatInputBackground
      : AppColors.chatInputBackground;
  ...
  Color get luxuryGradientStart => isDark
      ? AppColorsDark.luxuryGradientStart
      : AppColors.luxuryGradientStart;
  Color get luxuryGradientEnd =>
      isDark ? AppColorsDark.luxuryGradientEnd : AppColors.luxuryGradientEnd;
